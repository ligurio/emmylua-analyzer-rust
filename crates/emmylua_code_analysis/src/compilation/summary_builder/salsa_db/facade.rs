...
use crate::{
    ...
    SalsaLexicalUseSummary, SalsaMemberIndexSummary, SalsaMemberSummary, SalsaMemberTargetHandle,
...
impl<'db> SalsaSummaryFileQueries<'db> {
    ...
    pub fn summary(&self, file_id: FileId) -> Option<SalsaFileSummary> {
        tracked::file_summary(self.db, file_id)
    }

    pub fn decl_tree(&self, file_id: FileId) -> Option<SalsaDeclTreeSummary> {
    ...
    pub fn globals(&self, file_id: FileId) -> Option<SalsaGlobalSummary> {
        tracked::file_global_summary(self.db, file_id)
    }

    pub fn members(&self, file_id: FileId) -> Option<SalsaMemberIndexSummary> {
    ...
    pub fn properties(&self, file_id: FileId) -> Option<SalsaPropertyIndexSummary> {
        tracked::file_property_summary(self.db, file_id)
    }

    pub fn table_shapes(&self, file_id: FileId) -> Option<SalsaTableShapeIndexSummary> {
    ...
    pub fn properties_for_member(
        &self,
        file_id: FileId,
        member_target: impl Into<SalsaMemberTargetHandle>,
    ) -> Option<Vec<SalsaPropertySummary>> {
...
impl<'db> SalsaSummaryDocQueries<'db> {
    ...
    pub fn summary(&self, file_id: FileId) -> Option<SalsaDocSummary> {
    ...
    pub fn types(&self, file_id: FileId) -> Option<SalsaDocTypeIndexSummary> {
        tracked::file_doc_type_summary(self.db, file_id)
    }

    pub fn lowered_types(&self, file_id: FileId) -> Option<SalsaDocTypeLoweredIndex> {
    ...
    pub fn resolved_types(&self, file_id: FileId) -> Option<SalsaDocTypeResolvedIndex> {
    ...
    pub fn signatures(&self, file_id: FileId) -> Option<SalsaSignatureIndexSummary> {
        tracked::file_signature_summary(self.db, file_id)
    }

    pub fn signature_explain_index(&self, file_id: FileId) -> Option<SalsaSignatureExplainIndex> {
    ...
    pub fn owner_bindings(&self, file_id: FileId) -> Option<SalsaDocOwnerBindingIndexSummary> {
        tracked::file_doc_owner_binding_summary(self.db, file_id)
    }

    pub fn owner_resolve_index(&self, file_id: FileId) -> Option<SalsaDocOwnerResolveIndex> {
...
impl<'db> SalsaSummaryLexicalQueries<'db> {
    ...
    pub fn use_sites(&self, file_id: FileId) -> Option<SalsaUseSiteIndexSummary> {
    ...
    pub fn use_index(&self, file_id: FileId) -> Option<SalsaLexicalUseIndex> {
...
impl<'db> SalsaSummaryFlowQueries<'db> {
    ...
    pub fn summary(&self, file_id: FileId) -> Option<SalsaFlowSummary> {
        tracked::file_flow_summary(self.db, file_id)
    }

    pub fn block(&self, file_id: FileId, block_offset: TextSize) -> Option<SalsaFlowBlockSummary> {
    ...
    pub fn query(&self, file_id: FileId) -> Option<SalsaFlowQuerySummary> {
        tracked::file_flow_query_summary(self.db, file_id)
    }

    pub fn for_range_iter_index(&self, file_id: FileId) -> Option<SalsaForRangeIterQueryIndex> {
...
impl<'db> SalsaSummaryModuleQueries<'db> {
    ...
    pub fn resolve_index(&self, file_id: FileId) -> Option<crate::SalsaModuleResolveIndex> {
        tracked::file_module_resolve_index(self.db, file_id)
    }

    pub fn summary(&self, file_id: FileId) -> Option<SalsaModuleSummary> {
    ...
    pub fn exports_closure(&self, file_id: FileId, signature_offset: u32) -> Option<bool> {
        tracked::file_module_exports_closure(self.db, file_id, signature_offset)
    }

    pub fn exports_table(&self, file_id: FileId, table_offset: u32) -> Option<bool> {
...
impl<'db> SalsaSummaryTypeQueries<'db> {
    ...
    pub fn decl_index(&self, file_id: FileId) -> Option<SalsaDeclTypeQueryIndex> {
    ...
    pub fn global_index(&self, file_id: FileId) -> Option<SalsaGlobalTypeQueryIndex> {
    ...
    pub fn member_index(&self, file_id: FileId) -> Option<SalsaMemberTypeQueryIndex> {
...
impl<'db> SalsaSummarySemanticFileQueries<'db> {
    ...
    pub fn summary(&self, file_id: FileId) -> Option<SalsaSingleFileSemanticSummary> {
    ...
    pub fn module_export(&self, file_id: FileId) -> Option<SalsaModuleExportSemanticSummary> {
    ...
    pub fn graph(&self, file_id: FileId) -> Option<crate::SalsaSemanticGraphSummary> {
        tracked::file_semantic_graph(self.db, file_id)
    }

    pub fn graph_index(&self, file_id: FileId) -> Option<crate::SalsaSemanticGraphQueryIndex> {
        tracked::file_semantic_graph_query_index(self.db, file_id)
    }

    pub fn graph_scc_index(&self, file_id: FileId) -> Option<crate::SalsaSemanticGraphSccIndex> {
    ...
    pub fn solver_worklist(&self, file_id: FileId) -> Option<SalsaSemanticSolverWorklistSummary> {
        tracked::file_semantic_solver_worklist(self.db, file_id)
    }

    pub fn solver_execution(&self, file_id: FileId) -> Option<SalsaSemanticSolverExecutionSummary> {
...
impl<'db> SalsaSummarySemanticTargetQueries<'db> {
    ...
    pub fn index(&self, file_id: FileId) -> Option<crate::SalsaSemanticTargetQueryIndex> {
